...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group bmd-form-group">
            <label class="bmd-label-floating">Vedio Name</label>
    ...
    <div class="col-md-6">
        <div class="form-group bmd-form-group">
            ...
            <select name="{{ $input }}" id="" class="form-control @error($input) is-invalid @enderror">
    ...
    <div class="col-md-12">
        <div class="form-group bmd-form-group">
            <label class="bmd-label-floating">Vedio Description</label>
