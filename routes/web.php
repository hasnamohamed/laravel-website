...
//Auth::routes();
Route::namespace('BackEnd')->prefix('')->middleware('admin')->group(function () {
    Route::get('/home', 'Home@index')->name('home');
    //Route::get('admin/home', 'BackEnd/Home@index')->name('home');//prefix mean the name pefore home first one and backend is the folder of home controller
...
Auth::routes();
Route::get('/fhome', 'HomeController@index')->name('fhome');
